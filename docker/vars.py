VARS = {
    ...
    "riemann": {
        ...
        "config_url": "https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.2rc1/plugins/riemann-controller/riemann_controller/resources/manager.config",
        "ports": ["5555"],
    ...
    "celery": {
        ...
        "modules": {
                "cloudify_rest_client": "git+git://github.com/cloudify-cosmo/cloudify-rest-client.git@3.2rc1",
                "cloudify_plugins_common": "git+git://github.com/cloudify-cosmo/cloudify-plugins-common.git@3.2rc1",
                "cloudify_script_plugin": "git+git://github.com/cloudify-cosmo/cloudify-script-plugin.git@1.2rc1",
                "cloudify_manager": "-b 3.2rc1 https://github.com/cloudify-cosmo/cloudify-manager.git",
            },
    ...
    "manager": {
        ...
        "modules": {
            "cloudify_rest_client": "git+git://github.com/cloudify-cosmo/cloudify-rest-client.git@3.2rc1",
            "cloudify_plugins_common": "git+git://github.com/cloudify-cosmo/cloudify-plugins-common.git@3.2rc1",
            "cloudify_amqp_influxdb": "git+git://github.com/cloudify-cosmo/cloudify-amqp-influxdb.git@3.2rc1",
            "cloudify_dsl_parser": "git+git://github.com/cloudify-cosmo/cloudify-dsl-parser.git@3.2rc1",
