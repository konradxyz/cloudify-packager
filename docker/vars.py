VARS = {
    ...
    "riemann": {
        ...
        "config_url": "https://raw.githubusercontent.com/cloudify-cosmo/cloudify-manager/3.2m2/plugins/riemann-controller/riemann_controller/resources/manager.config",
        "ports": ["5555"],
    ...
    "celery": {
        ...
        "modules": {
                ...
                "cloudify_script_plugin": "git+git://github.com/cloudify-cosmo/cloudify-script-plugin.git@1.2m2",
