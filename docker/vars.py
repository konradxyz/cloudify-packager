VARS = {
    ...
    "celery": {
        ...
        "modules": {
                "cloudify_rest_client": "git+git://github.com/cloudify-cosmo/cloudify-rest-client.git@3.2m1",
                "cloudify_plugins_common": "git+git://github.com/cloudify-cosmo/cloudify-plugins-common.git@3.2m1",
                "cloudify_script_plugin": "git+git://github.com/cloudify-cosmo/cloudify-script-plugin.git@1.2m1",
    ...
    "manager": {
        ...
        "modules": {
            "cloudify_amqp_influxdb": "git+git://github.com/cloudify-cosmo/cloudify-amqp-influxdb.git@3.2m1",
            "cloudify_dsl_parser": "git+git://github.com/cloudify-cosmo/cloudify-dsl-parser.git@3.2m1",
            "cloudify_manager": "-b 3.2m1 https://github.com/cloudify-cosmo/cloudify-manager.git",
        },
